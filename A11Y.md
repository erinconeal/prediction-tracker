...
- **Lazy Context Loading:** Reference files (`A11Y/references/`) **MUST NOT** be preloaded. They **MUST** be consulted only when the task explicitly involves that component type. The `A11Y.md` alone is sufficient for most code generation tasks.
...
### Perceivable
*References: [Images](A11Y/references/examples-images.md) | [Content & Timing](A11Y/references/examples-content-interaction.md)*
...
### Operable
*References: [Buttons](A11Y/references/examples-buttons.md) | [Modals](A11Y/references/examples-modals.md) | [Navigation](A11Y/references/examples-navigation.md)*
...
### Understandable
*References: [Forms & Errors](A11Y/references/examples-forms.md) | [Content & Microcopy](A11Y/references/examples-content-interaction.md)*
...
4. **Scale:** Create a reusable example in the `A11Y/references/` folder.
...
*Compliance must be verified through these steps (Refer to the [**Report Template**](A11Y/templates/REPORT.md) for final QA details):*
...
**Examples Guide:** [Practical Before/After Examples](A11Y/A11Y-EXAMPLES.md)

**Technical Guides:** [Images](A11Y/references/examples-images.md) | [Forms](A11Y/references/examples-forms.md) | [Buttons](A11Y/references/examples-buttons.md) | [Modals](A11Y/references/examples-modals.md) | [Navigation](A11Y/references/examples-navigation.md) | [Content](A11Y/references/examples-content-interaction.md) | [Visual Perception](A11Y/references/visual-perception.md) | [Governance](A11Y/references/governance.md)
...
**Optional Templates:** [Accessibility Report](A11Y/templates/REPORT.md) | [Exceptions Log](A11Y/templates/EXCEPTIONS.md)

### Sourced from [https://github.com/fecarrico/A11Y.md](https://github.com/fecarrico/A11Y.md)