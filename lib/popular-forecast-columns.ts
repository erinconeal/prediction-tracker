...
export const POPULAR_FORECAST_GRID_CLASS
  = 'grid list-none gap-4 lg:grid-cols-3 xl:grid-cols-4';

export const POPULAR_FORECAST_MAX_SLOTS = 4;

const LG_MIN_WIDTH_PX = 1024;
const XL_MIN_WIDTH_PX = 1280;

/** How many popular hero cards fit on one row at the given viewport width. */
export function popularForecastSlotCount(viewportWidth: number): number {
